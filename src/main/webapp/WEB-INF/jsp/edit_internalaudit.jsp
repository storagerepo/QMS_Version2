...
<table cellpadding="0" cellspacing="0" border="0" width="98%" class="margin_table">
      ...
      <tr> 
        <td valign="top" align="left">
			...
			<tr class="row1">
				                   	...
				                   	<br/>
				                   		<span id="auditorerror" style="color:red"></span><span class="err"><form:errors path="InternalAudits.auditor"></form:errors></span>
					                   	</td>	
							         </tr> 
						         </table>
			</c:if>
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
                ...
                <tr class="row1">
				                 ...
				                 <select name="process" id="id_inpprocess" onchange="doAjaxPost_for_process();" class="input_txtbx" disabled="disabled">
               						<option value="">--Select--</option>
               						<c:forEach items="${processForm.processes}" var="processes" varStatus="true">
               						<option value="<c:out value="${processes.process_name}"/>" <c:if test="${internalaudits.process==processes.process_name}"><c:out value="Selected"/></c:if>><c:out value="${processes.process_name}"/></option>
               						</c:forEach>
			...
			<tr class="row2">
               <tr class="row1">
                  <td valign="middle" align="left" class="input_txt" width="30%">Auditee name :</td>
                  <td valign="top" align="left" class="input_txt" width="30%">
                <select name="auditee_name" id="auditeename"  class="input_txtbx" disabled="disabled">
               <option value="">--Select--</option>
               <c:forEach items="${processForm.processes}" var="processes" varStatus="true">
               <option value="<c:out value="${processes.process_owner}"/>" <c:if test="${internalaudits.auditee_name==processes.process_owner}"><c:out value="Selected"/></c:if>><c:out value="${processes.process_owner}"/></option>
               </c:forEach>
			...
			<tr class="row1">
							         	<td valign="middle" align="left" class="input_txt">Auditor :</td>
							           <td valign="top" align="left" class="input_txt">
					                  		<select name="auditor" class="input_txtbx" id="auditor" disabled="disabled">
							                <option value="">--Select--</option>
						                     <option <c:if test="${internalaudits.auditor eq 'name1'}"><c:out value="Selected"/></c:if> value="name1" >Name1</option>
											<option <c:if test="${internalaudits.auditor eq 'name2'}"><c:out value="Selected"/></c:if> value="name2">Name2</option>
											<option  <c:if test="${internalaudits.auditor eq 'name3'}"><c:out value="Selected"/></c:if> value="name3">Name3</option>
 ...
 <table cellpadding="0" cellspacing="0" border="0" width="100%">
                ...
                <tr class="row1">
                  ...
                  <td valign="top" align="left" class="input_txt" width="30%"><input type="text" name="auditors_initials" class="input_txtbx" id="inp_auditors_initials" onkeydown="if(event.ctrlKey && event.keyCode==86){return false;}"  onmouseover="showTooltip('tooltip_id','inp_id3');" onmouseout="hideTooltip('tooltip_id');" value="${internalaudits.auditors_initials}"onkeypress="return onlyAlphabets(event,this);" />
...
$('#update').on('submit', function() {
    ...
    $('#auditeename').attr('disabled', false);
