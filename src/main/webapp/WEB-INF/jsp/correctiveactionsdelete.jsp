					...
					<div class="menu_c">
						  <ul class="horizmenu" >
								...
								<c:when test="${menu=='corrective'}">menubuttonsub blueactive</c:when><c:otherwise>menubuttonsub blueactive</c:otherwise></c:choose>">
									Delete Corrective & Preventive Actions
								</a>
							</li>
			     ...
			     <div style="border:#ccc 2px solid; padding:15px; margin-bottom:15px;">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
							  <tr>
							    ...
							    <td align="left" valign="middle" width="10%"><input type="text" name="capa_id" class="input_txtbx" id="capa_id" placeholder="1001" value="${capa}"  onkeypress="return Number(event,this);"></td>
