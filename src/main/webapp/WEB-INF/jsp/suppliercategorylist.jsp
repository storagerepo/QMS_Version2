...
<div id="right_content">
  ...
  <div class="clear"></div>
        		...
        		<td valign="top" align="left">
			      ...
			      <form action="suppliercategorylist" method="POST"> 
				     ...
				     <tr class="title">
							...
							<c:if test="${fn:length(addsuppliercategoryform.suppliercategory) gt 0}">
        				  <c:forEach items="${addsuppliercategoryform.suppliercategory}" var="documenttype" varStatus="status">
        				       				<tr class="row1">
        				       				
        				       				
        				       				
        				       				 <td valign="top" align="left" width="15%">${documenttype.category}</td>
        				       					<td valign="top" align="left">
												<a href="#" title="" ><img src="resources/images/icons/icon_edit.png" alt="Edit" /></a><a href="<c:out value="edit_suppliercategory?id=${documenttype.id}"/>" style="padding-right:10px;">Edit</a>
											<a href="#" title=""><img src="resources/images/icons/icon_delete.png" alt="Delete" /></a><a href="<c:out value="delete_suppliercategory?id=${documenttype.id}"/>" onclick="return confirmation()">Remove</a>
											</td>
        				       				 </tr>
        				       				 </c:forEach>
        				       				 </c:if>
	...
	<div class="extrabottom">
             ...
             <li class="page_unselect"><a href="viewsuppliertypereport_page?page=${currentpage - 1}" >Prev</a></li> 
               </c:if>
             ...
             <%-- <c:forEach var="count" begin="1" end="${noofrows}"> --%> 
               <c:forEach begin="1" end="${noofpages}" var="i">
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="page_unselect"><a href="viewsuppliertypereport_page?page=${i}"><c:out value="${i}"></c:out></a></li>
                    </c:otherwise>
                </c:choose>
            </c:forEach>          
            <c:if test="${currentpage!=noofpages}">
              <li class="page_unselect"><a href="viewsuppliertypereport_page?page=${currentpage+1}">Next</a></li> 
                 </c:if>
              <c:choose>
              <c:when test="${button=='viewall'}">
                  <li class="page"><a href="viewallsuppliercategorytypereport" class="paging_select">ViewAll</a></li>
             </c:when>
                <c:otherwise>
                  <li class="page"><a href="suppliercategorylist" class="paging_select">Back</a></li>
              </c:otherwise>
              </c:choose>					
...
function confirmation() {
	var answer = confirm("Are you sure want to remove supplier category?")
	if (answer){
		return true;
	}
	else{
